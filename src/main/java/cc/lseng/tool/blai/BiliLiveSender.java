...
public class BiliLiveSender {
    ...
    public static String sendDanmu(String roomId, String mes){
        ...
        headers.put("cookie", Configurations.cookie);
        ...
        params.put("bubble", "0");
        params.put("csrf_token", Configurations.csrf_token);
        params.put("csrf", Configurations.csrf);
    ...
    public static String sendShare(String roomId){
        ...
        return HttpUtils.sendPost("https://api.live.bilibili.com/xlive/web-room/v1/index/TrigerInteract", headers, params);
    }
